  ...
  return [
    {
      ...
      config: {
        ...
        inputSchema: {
          ...
          doubleOptInActive: z.boolean().optional().describe('Require confirmation before a new subscriber is fully active.'),
          doubleOptInTransactionalEmailId: z.string().optional().describe('The transactional email that sends the confirmation message, by id. Required if doubleOptInActive is true.'),
          doubleOptInTransactionalEmailName: z.string().optional().describe('The transactional email that sends the confirmation message, by name - looked up automatically. Required if doubleOptInActive is true and the id is not already known.'),
    ...
    },
    {
      ...
      config: {
        ...
        inputSchema: {
          ...
          doubleOptInTransactionalEmailName: z.string().optional().describe('Looked up automatically.'),
